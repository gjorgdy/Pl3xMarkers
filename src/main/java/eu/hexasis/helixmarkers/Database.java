...
public class Database {
    ...
    public Dao<SimpleLineEntity, String> dynamicLinePoints;
    ...
    public Database() throws SQLException {
        ...
        dynamicLinePoints = DaoManager.createDao(connection, SimpleLineEntity.class);
        TableUtils.createTableIfNotExists(connection, SimpleLineEntity.class);
    }
